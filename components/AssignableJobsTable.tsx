        ...
        <table className="w-full table-fixed border-collapse text-sm">
          ...
          <tbody>
            {sortedRows.length ? sortedRows.map((row) => (
              <tr key={row.id} className={`border-b border-slate-100 ${row.isHighlightedInsurance ? "bg-sky-50/80 ring-1 ring-inset ring-sky-200" : variant === "hold" ? "bg-amber-50" : variant === "tow_in" ? "bg-blue-50" : ""}`}>
